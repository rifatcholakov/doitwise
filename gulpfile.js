...
gulp.task("watch", function () {
	...
	gulp.watch(paths.source.sass + "**/*.scss", gulp.series("sass")).on(
		"change",
		browserSync.reload
	);
	gulp.watch(
		paths.source.scripts + "**/*.js",
		gulp.series("minifyScripts")
	).on("change", browserSync.reload);
	gulp.watch(paths.source.images + "*", gulp.series("optimizeImages")).on(
		"change",
		browserSync.reload
	);
	...
	gulp.watch(paths.destination.css + "master.css", gulp.series("cssmin")).on(
		"change",
		browserSync.reload
	);
});
